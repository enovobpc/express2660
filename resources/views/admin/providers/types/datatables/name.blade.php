...
{{ Form::open(['route' => ['admin.providers-types.update', $row->id], 'method' => 'PUT', 'data-remote' => 'true', 'class' => "form-edit-datatable-field form-inline hide"]) }}
<div class="input-group">
    {{ Form::text('name', $row->name, ['class' => 'form-control input-sm target-datatable-field', 'style' => 'width: 429px']) }}
    {{ Form::text('color', $row->color, ['class' => 'form-control input-sm target-datatable-field', 'style' => 'width: 429px']) }}
