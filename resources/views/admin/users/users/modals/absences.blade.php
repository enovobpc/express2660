<div class="modal" id="modal-print-absences">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            {{ Form::open(['route' => 'admin.export.operators.absences', 'method' => 'GET', 'target' => '_blank']) }}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
                    <span class="fs-15" aria-hidden="true"><i class="fas fa-times"></i></span>
                    <span class="sr-only">@trans('Fechar')</span>
                </button>
                <h4 class="modal-title"><i class="fas fa-file-refresh"></i> @trans('Resumo de Férias e Ausências')</h4>
            </div>
            <div class="modal-body">
                <p class="m-t-0 bold">@trans('Listar férias e ausências entre as datas:')</p>
                <div class="row row-5">
                    <div class="col-sm-6">
