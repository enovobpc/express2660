...
@section('breadcrumb')
    ...
    <li class="active">@trans('Acessórios')</li>
@stop
                    ...
                    <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable">
                        ...
                        <li>
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="{{ route('admin.fleet.export', ['accessories'] + Request::all()) }}"
                        ...
                        <li class="fltr-primary w-180px">
                            ...
                            <div class="pull-left form-group-sm w-130px">
                                {{ Form::selectMultiple('type', trans('admin/fleet.accessories.types'), fltr_val(Request::all(), 'type'), array('class' => 'form-control input-sm filter-datatable select2-multiple')) }}
                            </div>
                        </li>
