    ...
    <div class="guide-content">
                ...
                <div class="guide-row" style="border-bottom: 0;">
                    ...
                    <div class="guide-block-right border-bottom" style="padding-top: 2px; padding-bottom: 2px;  height: 6.8mm">
                        <div class="guide-block-title  lh-1-1">
                           <div class="pull-left" style="width: 30mm">LOCAL DE CARGA</div>
        ...
        <div class="guide-row" style="height: 6px">
            ...
            <div class="guide-block" style="border-bottom: 0; border: none">
                ...
                <div class="pull-left lh-1-0" style="width: 42mm;">
                ...
                <div class="pull-left lh-1-0 fs-8pt" style="width: 8mm;">
                    <div class="fs-7pt">&nbsp;</div>
                    <div class="fs-8pt">ADR</div>
                </div>
            </div>
        </div>
        <div class="guide-row">
     ...
     <div class="fs-6pt">
         <div class="pull-left fs-6pt" style="width: 65.5%"><b>A assinatura pressupõe aceitação condições de transporte disponíveis em {{ $shipment->recipientAgency->web }}</b></div>
