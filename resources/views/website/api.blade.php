...
<section class="row service-page-row">
    <div class="col-sm-12 col-md-5 col-xl-5 class-imagea hidden-xs" style="display: grid; align-content: center; justify-content: center;">
        <img class="visible-xl hidden-md hidden-sm  img2-about" src="{{ asset('assets/website/img/api-lg.png') }}" alt="sobre-nos" style="width:auto; max-height: 540px;">
        <img class="hidden-xl hidden-lg img2-about" src="{{ asset('assets/website/img/api-xs.png') }}" alt="sobre-nos" style="width:100%;">
    </div>
    <div class="col-sm-12 col-md-7 col-xl-7 " style=" display: flow; align-content: center;">
        <div class="rectangleab-storage" style="margin-top: 0">
            ...
            <h2 class="about2-home">{{trans('website.services.api.pageSubtitle')}}</h2>
