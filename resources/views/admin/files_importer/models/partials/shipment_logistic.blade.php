...
<div class="row row-5">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label>Serviço <i class="fas fa-info-circle" data-toggle="tooltip" title="@trans('Caso alguma linha a importar não possua serviço, será assumido o serviço aqui indicado.')"></i></label>
