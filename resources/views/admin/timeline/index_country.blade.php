        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab-calendar" data-toggle="tab">Vista por viatura</a></li>
                    <li><a href="#tab-map" data-toggle="tab">Vista por Destino</a></li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-map">
                        @include('admin.timeline.partials.country')
                    </div>
                </div>
            </div>
        </div>
                ...
                resourcesSet: function(resources) {
                    resources.forEach(function(item){
                        if(item.id) {
                            ...
                            var html_pos = item.extendedProps.html_pos;
                            var background = item.extendedProps.background;

                            if(typeof html_pos == 'undefined' || html_pos == 'after') {
                                $('[data-resource-id=' + item.id + ']').find('.fc-datagrid-cell-main').after(html);
                            } else {
                                $('[data-resource-id=' + item.id + ']').find('.fc-datagrid-cell-main').prev(html);
                            }
