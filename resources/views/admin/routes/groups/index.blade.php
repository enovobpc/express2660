<div class="modal-header">
    ...
    <h4 class="modal-title">@trans('Gerir Grupos de Rotas')</h4>
</div>
<div class="modal-body p-b-0">
    {{ Form::model($routeGroup, $formOptions) }}
    <div class="row row-5">
        <div class="col-sm-3">
            <div class="form-group is-required">
                {{ Form::label('code', __('Código')) }}
                {{ Form::text('code', null, ['class' => 'form-control nospace', 'maxlength' => 25, 'required']) }}
            </div>
        </div>
        <div class="col-sm-7">
            <div class="form-group is-required">
...
<script>
    ...
    $(document).ready(function () {
        oTableModal = $('#datatable-modal').DataTable({
            ...
            order: [[1, "asc"]],
            ajax: {
                url: "{{ route('admin.routes.groups.datatable') }}",
                type: "POST",
                data: function (d) {},
