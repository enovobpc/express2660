@if(@$shipmentAttachments->isEmpty())
    <div class="text-center text-muted p-5 m-t-40">
        <h4><i class="fas fa-info-circle"></i> Não Há anexos para este envio.</h4>
        <a href="{{ route('admin.shipments.attachments.create', $shipment->id) }}"
...
@else
    <table id="datatable" class="table m-b-0">
        <tr>
            ...
            <th class="bg-gray-light w-35px">Cliente</th>
            <th class="bg-gray-light w-50px">App</th>
            ...
            <tr>
                ...
                <td class="vertical-align-middle text-right">
                    <div class="action-buttons">
                        <a href="{{ route('admin.shipments.attachments.edit', [$item->source_id, $item->id]) }}"
                           data-toggle="modal"
                           data-target="#modal-remote"
                           class="text-green">
                            <i class="fas fa-pencil-alt"></i>
                        </a>
                        <a href="{{ route('admin.shipments.attachments.destroy', [$item->source_id, $item->id]) }}"
                           data-method="delete"
    ...
    <a href="{{ route('admin.shipments.attachments.create', $item->source_id) }}"
