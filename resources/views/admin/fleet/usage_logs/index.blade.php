...
@section('breadcrumb')
    ...
    <li class="active">@trans('Registos de utilização')</li>
@stop
            ...
            <div class="box no-border">
                <div class="box-body">
                    <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable">
                        <li>
                            <a href="{{ route('admin.fleet.usages.create') }}"
                        ...
                        <li>
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="{{ route('admin.fleet.export', ['usages'] + Request::all()) }}"
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-dashed table-hover table-condensed">
                            ...
                            <tr>
                                ...
                                <th></th>
                                <th class="w-150px">@trans('Viatura')</th>
                                <th class="w-120px">@trans('Motorista')</th>
                                <th class="w-100px">@trans('Tipo')</th>
                                <th class="w-95px">@trans('Data Início')</th>
                                <th class="w-60px">@trans('Km Início')</th>
                                <th class="w-95px">@trans('Data Fim')</th>
                                <th class="w-60px">@trans('Km Fim')</th>
                                <th class="w-70px">@trans('Duração')</th>
                                <th class="w-70px">@trans('Km totais')</th>
                                <th class="w-120px">@trans('Serviços')</th>
                    ...
                    <div class="selected-rows-action hide">
                        {{ Form::open(array('route' => 'admin.fleet.usages.selected.destroy')) }}
