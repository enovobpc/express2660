...
?>
{{ Form::open(['route' => 'admin.logistic.products.adjustment.store', 'method' => 'POST']) }}
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">
        <span class="fs-15" aria-hidden="true"><i class="fas fa-times"></i></span>
        <span class="sr-only">@trans('Fechar')</span>
    </button>
    <h4 class="modal-title">@trans('Ajustar stock')</h4>
</div>
                ...
                <div class="col-sm-12">
                    <table class="table table-condensed m-b-0">
                        <tr class="bg-gray-light">
                            ...
                            <th class="w-80px text-center">@trans('Qtd Atual')</th>
                            <th class="w-80px text-center">@trans('Qtd Real')</th>
                        </tr>
...
<script>
    ...
    function getProduct() {
        ...
        $('.modal .loading').show();
        $.get('{{ route('admin.logistic.products.adjustment.edit') }}', {barcode:barcode}, function (data) {
            if (data.result) {
