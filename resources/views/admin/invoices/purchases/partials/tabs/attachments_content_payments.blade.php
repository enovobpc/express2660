@if(@$invoiceAttachments->isEmpty())
    <div class="text-center text-muted p-5 m-t-40">
        ...
        <a href="{{ route('admin.invoices.purchase.attachments.create', [$paymentNote->id, 'type' => 'PurchasePaymentNote']) }}"
...
@else
    ...
    <a href="{{ route('admin.invoices.purchase.attachments.create', [$item->source_id, 'type' => 'PurchasePaymentNote']) }}"
