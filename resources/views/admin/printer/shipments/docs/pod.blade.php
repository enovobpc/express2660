...
<div style="padding: 4mm; height: 92mm; width: 205mm; font-size: 11px; color: #000;">
    ...
    <div style="float: left; width: 135mm; height: 47mm;">
        ...
        <div class="box" style="width:64.5mm; height:23mm;">
            <span class="txlabel">Observações de Entrega</span><br/>
            <div style="font-weight: bold; line-height: 6px; height: 8mm">{{ @$shipment->obs }}</div>
            <div>{{ @$shipment->last_history->obs }}</div>
    ...
    <div style="float: left; width: 65.4mm; height: 47mm; margin-left: 1.5mm;">
        <div class="box">
        <span style="font-weight: bold; font-size: 14px;">Comprovativo Entrega</span><br/>
            Receptor: <span style="color: blue; font-weight: bold;">{{ @$shipment->last_history->receiver }}</span><br/>
        ...
        <div style="text-align: center; height: 29mm;">
            ...
            Data/Hora Entrega: <span style="color: blue; font-weight: bold">{{ @$shipment->last_history->created_at }}</span>
        </div>
    </div>
    <div style="font-size: 9px; width: 204mm; margin-top: -5px; margin-bottom: -10px">
        <div style="float: left; width: 132mm; font-style: italic; font-weight: bold">
            Este comprovativo de entrega é uma imagem simulada, cuja assinatura foi recolhida em dispositivo electrónico.
        </div>
