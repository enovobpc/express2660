...
<img src="{{ asset('/assets/img/default/maintenance.svg') }}" class="bg-image">
<div class="content-container">
    <div class="head-line secondary-text-color">
        <img src="http://enovo.pt/assets/img/logo/logo_white_sm.png"/>
    </div>
    <div class="subheader primary-text-color">
        Estamos a proceder a uma <br>
        manutenção programada.
    </div>
    <hr>
    <div class="clearfix"></div>
    <div class="context primary-text-color">
        <p>De momento estamos a trabalhar para melhorar a sua experiência. Voltamos dentro de {{ Setting::get('maintenance_time') }} minutos.</p>
        <br/>
