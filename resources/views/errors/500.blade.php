...
$messages = [
    ...
    'Upps, Algo correu mal!',
    'Grrrr...Outra vez!',
    'Uma equipa de macacos treinados está a resolver!',
    'Bem, o problema é nosso!'*/
    'Bem, isto não estava previsto!'
];
...
<head>
    ...
    <style>
        ...
        .background-color {
            /*background-color: rgba(12, 51, 85, 1) !important;*/
        ...
        .secondary-text-color {
            ...
            /*color: rgba(66, 103, 135, 1) !important;*/
        }
...
<img src="{{ asset('/assets/img/default/danger.svg') }}" class="bg-image">
<div class="content-container">
    <div class="head-line secondary-text-color">
        <img src="{{ asset('assets/img/logo/logo_sm.png') }}" style="height: 50px; margin-bottom: 30px"/>
    </div>
    ...
    <div class="context primary-text-color">
        <p>
            {{--Ocorreu um erro no servidor ao processar o seu pedido.--}}
            Ocorreu uma problema técnico ao processar o seu pedido.
            Volte atrás ou reporte-nos o problema.
        </p>
    </div>
    <div class="buttons-container">
        <a class="border-button" href="mailto:suporte@enovo.pt?subject=[{{ config('app.source') }}] Comunicação de Erro" target="_blank">Reportar problema</a>
    </div>
