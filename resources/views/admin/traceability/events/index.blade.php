<div class="modal-header">
    ...
    <h4 class="modal-title">Gerir eventos de leitura</h4>
</div>
    ...
    <div class="row row-5">
        ...
        <div class="col-sm-2">
            <div class="form-group is-required">
                ...
                {{ Form::select('action', ['' => ''] + $actions, null, ['class' => 'form-control select2', 'required']) }}
            </div>
        </div>
        <div class="col-sm-2">
            <div class="form-group is-required">
        ...
        <div class="col-sm-2">
            <div class="form-group is-required">
                ...
                <a href="{{ route('admin.tracking.status.index') }}" class="pull-right" target="_blank"><small><i class="fas fa-cog"></i> Gerir/Adic.</small></a>
        ...
        <div class="col-sm-1">
            ...
            <button type="submit" class="btn btn-sm btn-block btn-success" data-loading-text="<i class='fas fa-spin fa-circle-notch'></i>"><i class="fas fa-plus"></i></button>
        </div>
    </div>
    {{ Form::close() }}
...
<script>
    ...
    $(document).ready(function () {
        oTableModal = $('#datatable-modal').DataTable({
            ...
            order: [[1, "asc"]],
            ajax: {
                url: "{{ route('admin.traceability.events.datatable') }}",
                type: "POST",
                data: function (d) {},
