...
?>
<div class="modal modal-filter-dates" id="modal-map-summary-vehicle">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            {{ Form::open(['route' => ['admin.printer.invoices.purchase.map', 'vehicle'], 'method' => 'GET', 'target' => '_blank']) }}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
                    <span class="fs-15" aria-hidden="true"><i class="fas fa-times"></i></span>
                    <span class="sr-only">Fechar</span>
                </button>
                <h4 class="modal-title"><i class="fas fa-file-refresh"></i> Mapa resumo de despesas por Viatura/Motorista</h4>
            </div>
                        ...
                        <div class="form-group is-required m-0">
                            <div class="checkbox m-0">
                                <label style="padding-left: 0">
                                    {{ Form::checkbox('details', 1, true) }}
                                    Incluir detalhe por viatura e por operador
                                </label>
                            </div>
                        </div>
                    </div>
