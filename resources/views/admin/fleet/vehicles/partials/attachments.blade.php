<div class="box no-border">
    <div class="box-body">
        <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable-attachments">
            <li>
                <a href="{{ route('admin.fleet.vehicles.attachments.create', $vehicle->id) }}" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-remote">
                    <i class="fas fa-plus"></i> @trans('Novo')
                </a>
            </li>
            <li>
                <a href="{{ route('admin.fleet.vehicles.attachments.sort', [$vehicle->id]) }}" class="btn btn-default btn-sm sort-attachments" data-toggle="modal" data-target="#modal-remote">
        ...
        <div class="selected-rows-action hide">
            {{ Form::open(['route' => ['admin.fleet.vehicles.attachments.selected.destroy', $vehicle->id]]) }}
