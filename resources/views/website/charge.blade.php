...
<section class="topo-about" style="height: 380px; position:relative; background: url('/assets/website/img/topo-servicos.png'); background-size: cover; background-position: bottom 0px left 0px; display: flex; align-items: flex-end; display: flex; align-items: center;">
    <div class="col-sm-12 todos-topos">
        <h1 class="text-top-about">{{trans('website.services.charge.title')}}</h1>
        <div style="display: flex; align-items: center; margin-top:15px;">
            <p class="text-top2">HOME > </p>
            <p class="text-top2">&nbspServiços > </p>
            <p class="text-top2" style="text-decoration: underline;">&nbsp{{trans('website.services.charge.title')}}</p>
        </div>
    </div>
</section> 
<section class="row service-page-row">
    <div class="col-sm-12 col-md-5 col-xl-5 class-imagea hidden-xs" style="display: grid; align-content: center; justify-content: center;">
        <img class="visible-xl hidden-md hidden-sm  img2-about" src="{{ asset('assets/website/img/cobrancas-lg.png') }}" alt="sobre-nos" style="width:auto; max-height: 540px;">
        <img class="hidden-xl hidden-lg img2-about" src="{{ asset('assets/website/img/cobrancas-xs.png') }}" alt="sobre-nos" style="width:100%;">
    </div>
    <div class="col-sm-12 col-md-7 col-xl-7 " style=" display: flow; align-content: center;">
        <div class="rectangleab-storage" style="margin-top: 0">
            <h4 class="about-home">{{trans('website.services.charge.title')}}</h4>
            <h2 class="about2-home">{{trans('website.services.charge.pageSubtitle')}}</h2>
            <p class="textabout-home">{{trans('website.services.charge.longDescription')}}</p>
        </div>
    </div>
