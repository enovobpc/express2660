<div class="modal fade" id="modal-import-global-prices-table">
    <div class="modal-dialog">
        <div class="modal-content">
            {{ Form::open(['route' => ['admin.providers.services.import', $provider->id, 'source' => 'prices-table', 'agency' => Request::get('agency')]]) }}
            ...
            <div class="modal-body">
                ...
                <p class="m-0">
                    <i class="fas fa-info-circle text-info"></i> <b>@trans('Atenção!')</b> @trans('Ao importar, a tabela de preços do será subscrita e substituída.')'
                </p>
            </div>
            <div class="modal-footer">
                <div class="pull-right">
                    {{ Form::text('type', Request::get('type')) }}
