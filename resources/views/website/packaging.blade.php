...
<section class="topo-about" style="height: 380px; position:relative; background: url('/assets/website/img/topo-servicos.png'); background-size: cover; background-position: bottom 0px left 0px; display: flex; align-items: flex-end; display: flex; align-items: center;">
    <div class="col-sm-12 todos-topos">
        ...
        <div style="display: flex; align-items: center; margin-top:15px;">
            <p class="text-top2" ><a style="color: white!important;" href="{{route('home.index')}}">HOME > </a></p>
            <p class="text-top2 "><a style="color: white!important;" href="{{route('services.index')}}">&nbspServiços > </a></p>
...
<section class="row service-page-row">
    <div class="col-sm-12 col-md-5 col-xl-5 class-imagea hidden-xs" style="display: grid; align-content: center; justify-content: left; overflow:hidden;">
        <img class="visible-xl hidden-md hidden-sm  img2-about" src="{{ asset('assets/website/img/embalamento-lg.png') }}" alt="sobre-nos" style="width:auto; max-height: 540px;">
        <img class="hidden-xl hidden-lg img2-about" src="{{ asset('assets/website/img/embalamento-xs.png') }}" alt="sobre-nos" style="width:100%;">
    </div>
    ...
    <div class="col-sm-12 col-md-5 col-xl-5 class-imagea visible-xs" style="display: grid; align-content: center; justify-content: center;">
        <img class="img2-about" src="{{ asset('assets/website/img/embalamento-lg.png') }}" alt="sobre-nos" style="width:auto; max-height: 540px;">
