<div class="text-center">
    <div class="btn-group">
        <a href="{{ route('admin.fleet.reminders.edit', [$row->id, 'vehicle' => $row->vehicle_id]) }}"
        ...
        <ul class="dropdown-menu pull-right">
            <li>
                <a href="{{ route('admin.fleet.reminders.destroy', [$row->id, 'vehicle' => $row->vehicle_id]) }}" data-method="delete"
