<div class="box no-border">
    <div class="box-body">
        <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable-contacts"> 
            <li>
                <a href="{{ route('admin.customers.contacts.create', $prospect->id) }}" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-remote">
        ...
        <div class="selected-rows-action hide">
            {{ Form::open(['route' => ['admin.customers.contacts.selected.destroy', $prospect->id]]) }}
