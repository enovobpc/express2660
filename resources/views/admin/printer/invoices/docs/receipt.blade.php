...
<div style="width: 100%; height: 14mm; text-align: right; position: absolute; top: -10px; right: 10px;">
    ...
    <h4 style="margin: 3px 0 3px; font-size: 18px; font-weight: bold">{{ transLocale('admin/global.word.receipt_no', $locale) }} {{ strtoupper($invoice->doc_series) }} {{ $invoice->doc_id }}</h4>
...
<div class="invoice" style="width: 210mm; font-size: 10pt; height: 261mm;">
    ...
    <div class="guide-content" style="height: 150mm">
        <h4 style="font-weight: bold; font-size: 16px; margin: 15px 0 0 0">
            {{ transLocale('admin/global.word.received_qty', $locale, ['total' => money($invoice->doc_total, Setting::get('app_currency'))]) }}
            @if($locale == 'pt')
        ...
        <div style="margin-top: 20px">
            ...
            <p>{{ transLocale('admin/global.word.to_pay_documents', $locale) }}</p>
        </div>
        ...
        <h4 style="text-align: right; font-weight: bold">{{ transLocale('admin/global.word.total_paid', $locale) }}: {{ money(@$totalPaid, Setting::get('app_currency')) }}</h4>
    </div>
</div>
