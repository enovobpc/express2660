<div class="cmr-label" style="height: 290mm; width: 210mm;">
    <div style="position: absolute; width: 100%; margin-left: -7mm">
        <div style="font-size: 30px; float: left; width: 25px;margin-top: -10px">{{ $copy }}</div>
        <div style="font-size: 7px; float: left; width: 200px; padding-top: 9px; line-height: 9px;">
            Cópia para <span style="font-weight: bold;">{{ @$copyDesignationPt }}</span><br />
            Copy for <span style="font-weight: bold;">{{ @$copyDesignationEn }}</span>
        </div>
    </div>
    <div class="cmr-row">
