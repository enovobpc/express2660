<ul class="datatable-filters list-inline hide pull-left" data-target="#datatable-categories">
    <li>
        <a href="{{ route('admin.api.docs.categories.create') }}" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-remote">
            <i class="fas fa-plus"></i> Novo
        </a>
    </li>
    <li>
        <a href="{{ route('admin.api.docs.categories.sort') }}" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-remote">
...
<div class="selected-rows-action hide">
    {{ Form::open(array('route' => 'admin.api.docs.categories.selected.destroy')) }}
