<div class="text-center">
    <div class="btn-group">
        <a href="{{ route('admin.fleet.fixed-costs.edit', [$row->id, 'vehicle' => $row->vehicle_id]) }}" class="btn btn-sm btn-default"
           data-toggle="modal"
        ...
        <ul class="dropdown-menu pull-right">
            <li>
                <a href="{{ route('admin.fleet.fixed-costs.destroy', [$row->id, 'vehicle' => $row->vehicle_id]) }}" data-method="delete"
