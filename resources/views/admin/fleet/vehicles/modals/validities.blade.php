<div class="modal" id="modal-print-validities">
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            {{ Form::open(['route' => 'admin.fleet.printer.validities', 'method' => 'GET', 'target' => '_blank']) }}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
                    <span class="fs-15" aria-hidden="true"><i class="fas fa-times"></i></span>
                    <span class="sr-only">@trans('Fechar')</span>
                </button>
                <h4 class="modal-title"><i class="fas fa-file-refresh"></i> @trans('Resumo de validades a expirar')</h4>
            </div>
            <div class="modal-body">
                <p class="m-t-0 bold">@trans('Listar validades a expirar entre as datas:')</p>
                <div class="row row-5">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <div class="checkbox m-b-0" style="padding-left: 0px">
                            <label style="padding-left: 0">
                                {{ Form::checkbox('expireds', 1, true) }} @trans('Incluir lembretes expirados')
                            </label>
                        </div>
                    </div>
                </div>
