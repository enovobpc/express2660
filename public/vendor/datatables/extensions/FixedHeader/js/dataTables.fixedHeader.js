...
FixedHeader.prototype = {
	...
	_fnScrollHorizontalRight: function ( oCache )
	{
		...
		if ( oWin.iScrollRight < oMes.iTableRight )
		{
			...
			this._fnUpdateCache( oCache, 'sLeft', (oMes.iTableLeft+oMes.iTablew-iFixedWidth)+"px", 'left', nTable.style );
		}
		else if ( oMes.iTableLeft < oDoc.iw-oWin.iScrollRight-iFixedWidth )
		{
			/* Middle */
			this._fnUpdateCache( oCache, 'sPosition', 'fixed', 'position', nTable.style );
			this._fnUpdateCache( oCache, 'sTop', (oMes.iTableTop-oWin.iScrollTop)+"px", 'top', nTable.style );
			this._fnUpdateCache( oCache, 'sLeft', (oWin.iw-iFixedWidth)+"px", 'left', nTable.style );
		}
		else
		{
			/* Fully left aligned */
	...
	_fnScrollHorizontalLeft: function ( oCache )
	{
		...
		else if ( oWin.iScrollLeft < oMes.iTableLeft+oMes.iTablew-iCellWidth )
		{
			this._fnUpdateCache( oCache, 'sPosition', 'fixed', 'position', nTable.style );
			this._fnUpdateCache( oCache, 'sTop', (oMes.iTableTop-oWin.iScrollTop)+"px", 'top', nTable.style );
		...
		else
		{
			...
			this._fnUpdateCache( oCache, 'sPosition', 'absolute', 'position', nTable.style );
			this._fnUpdateCache( oCache, 'sTop', oMes.iTableTop+"px", 'top', nTable.style );
			this._fnUpdateCache( oCache, 'sLeft', (oMes.iTableLeft+oMes.iTablew-iCellWidth)+"px", 'left', nTable.style );
		}
	},
