...
class Product extends \App\Models\InvoiceGateway\KeyInvoice\Base {
     ...
     * @throws \Exception
     */
    public function insertOrUpdateProduct($ref, $designation, $taxValue, $price, $isService = 1, $hasStocks = 0, $active = true, $shortName = null, $obs = null, $shortDesc = null, $longDesc = null, $vendorRef = null)
    {
