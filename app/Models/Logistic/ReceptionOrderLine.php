...
class ReceptionOrderLine extends \App\Models\BaseModel
{
     ...
     * @var string
     */
    protected $table = 'reception_orders_lines';
     ...
     */
    protected $fillable = [
        'reception_order_id', 'product_id', 'location_id', 'qty', 'qty_received', 'price', 'unity'
    ];
