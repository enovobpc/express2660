@section('title')
    Orçamentos - Courier e Carga Geral
@stop
...
<li class="active">Orçamentos - Courier e Carga Geral</li>
@stop
        ...
        <div class="box no-border">
            <div class="box-body">
                <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable">
                    <li>
                        <a href="{{ route('admin.budgets.courier.create') }}" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-remote-lg">
                        ...
                        <div class="btn-group btn-group-sm" role="group">
                            <div class="btn-group btn-group-sm" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.budgets.courier.services.index') }}" data-toggle="modal" data-target="#modal-remote-lg">
                                            <i class="fas fa-fw fa-list"></i> Gerir tipos de Serviço
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.budgets.courier.stats') }}" data-toggle="modal" data-target="#modal-remote-lg">
                                            <i class="fas fa-fw fa-chart-bar"></i> Estatísticas Mensal
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.budgets.courier.stats', ['type' => 'total']) }}" data-toggle="modal" data-target="#modal-remote-lg">
                                            <i class="fas fa-fw fa-chart-bar"></i> Estatísticas Totais
                                        </a>
                                    </li>
                                </ul>
                            </div>
