<div class="modal-header">
    ...
    <h4 class="modal-title">@trans('Picking In')</h4>
</div>
<div class="modal-body">
    <div class="form-group form-group-lg">
        {{ Form::label('code', __('Indique a ordem a iniciar Picking In'), ['class' => 'fs-15 m-b-10']) }}
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary btn-submit" data-loading-text="<i class='fas fa-spin fa-circle-notch'></i> A iniciar picking...">@trans('Iniciar Picking In')</button>
</div>
...
<script>
    ...
    function openPicking() {
        ...
        $.get('{{ route('admin.logistic.reception-orders.confirmation.create') }}', {code:code}, function(data){
            if(data.result) {
