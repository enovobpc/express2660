...
return
    ...
    [
         /*
         * The year the site was registered in google analytics
         */
        'startYear' => env('ANALYTICS_START_YEAR'),
         ...
         */
        'certificatePath' => storage_path('laravel-analytics/paulocosta-development-d693174d5763.p12'),
