<ul class="datatable-filters list-inline hide pull-left" data-target="#datatable-subcategories">
    <li>
        <a href="{{ route('admin.logistic.subcategories.create') }}"
    ...
    <li>
        <a href="{{ route('admin.logistic.subcategories.sort') }}"
    ...
    <li class="fltr-primary w-200px">
        ...
        <div class="pull-left form-group-sm w-130px">
            {{ Form::selectMultiple('category', $categories, Request::has('category') ? Request::get('category') : null, array('class' => 'form-control input-sm w-100 filter-datatable select2-multiple', 'data-placeholder' => __('Todos'))) }}
        </div>
    </li>
</ul>
<div class="table-responsive">
    <table id="datatable-subcategories" class="table table-striped table-dashed table-hover table-condensed">
        <thead>
        <tr>
            <th class="w-1">{{ Form::checkbox('select-all', '') }}</th>
            <th></th>
            <th>@trans('Nome')</th>
            <th class="w-250px">@trans('Categoria')</th>
...
<div class="selected-rows-action hide">
    {{ Form::open(array('route' => 'admin.logistic.subcategories.selected.destroy')) }}
