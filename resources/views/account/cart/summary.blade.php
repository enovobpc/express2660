...
@section('content')
    <div class="container">
        ...
        {{-- AGUARDA CONFIRMAÇÃO 3D SECURITY STRIPE --}}
        {{-- @elseif(@$order->payment_method->method == 'stripe' && @$paymentDetails->status == 'pending')
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-body">
                            <div class="col-sm-12 text-center">
                                ...
                                <h3 class="media-heading font-weight-normal m-t-5">Aceite o pagamento no seu telemóvel.</h3>
                                <p class="bigger-120 m-t-5">
                                    O seu 3D Secure foi ativo.
                                    <br/>
                                    Para finalizar a compra, responda corretamente dentro do tempo limite.
                                </p>
                                <h2>
                                    <i class="fas fa-spin fa-spinner"></i>
                                    <span class="timer-countdown">05:00</span>
...
@section('scripts')
    ...
    @elseif(@$order->payment_method->method == 'stripe' && @$paymentDetails->status == 'pending')
    <script>
        setInterval(function(){validateCallBack();}, 3000);
