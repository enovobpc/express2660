...
class FixedCost extends \App\Models\BaseModel
{
    use SoftDeletes,
        FileTrait;
     ...
     * Constant variables
     */
    const CACHE_TAG = 'cache_fleet_fixed_costs';
     ...
     * @var string
     */
    protected $table = 'fleet_fixed_costs';
     ...
     */
    protected $fillable = [
        'vehicle_id', 'type', 'provider_id', 'description', 'start_date', 'end_date', 'total', 'obs'
    ];
