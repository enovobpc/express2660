@section('title')
    {{ trans('website.legal.cookies.subtitle') }} |
@stop

@section('metatags')
    <meta property="og:title" content="{{ trans('website.legal.cookies.title') }}">
...
<div class="title-page">
    ...
    <section class="legal">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h1 style="margin-left:0;" class="title">{{ trans('website.legal.cookies.title') }}</h1>
                </div>
