@if(@$schedule)
    <div class="shipment-schedule-panel">
        <div class="row">
            <div class="col-sm-2" style="padding: 0;margin: 0;width: 250px;">
                <div class="form-group form-group-sm m-b-0" style="margin-right: 30px">
                    {{ Form::label('schedule_frequency', 'Repetir a cada', ['class' => 'col-sm-4 control-label', 'style' => 'padding: 5px 5px 0 0; width: 120px;']) }}
            ...
            <div class="col-sm-2 schedule-repeat form-group-sm p-0" style="{{ $schedule->repeat ? '' : 'display: none' }}">
                {{ Form::label('schedule_repeat', 'Repetir', ['class' => 'col-sm-4 control-label p-0 m-t-2']) }}
            ...
            <div class="col-sm-4 schedule-month-days form-group-sm p-0" style="{{ $schedule->repeat == 'day' ? '' : 'display: none' }}">
                {{ Form::label('schedule_month_days', 'Dias', ['class' => 'col-sm-1 control-label p-0 m-t-2']) }}
                <div class="col-sm-11 p-r-0 p-l-5">
                    {{ Form::selectRange('schedule_month_days[]', 1, 31 , @$schedule->month_days, ['class' => 'form-control select2', 'multiple']) }}
                </div>
            </div>
            <div class="col-sm-4 schedule-weekdays p-0" style="{{ $schedule->frequency == 'day' ||  $schedule->repeat == 'day' ? 'display: none' : '' }}">
                <div class="form-group form-group-sm m-b-0 p-t-3">
                    {{ Form::label('schedule_weekdays', 'No dia', ['class' => 'col-sm-2 p-l-0 p-r-5 control-label', 'style' => 'padding-top: 3px;']) }}
            ...
            <div class="col-sm-3">
                <div class="form-group form-group-sm m-b-0" style="margin-right: -50px;">
                    {{ Form::label('schedule_end_time', 'Termina', ['class' => 'col-sm-2 control-label p-0 m-t-2 m-r-2 m-l-10']) }}
                    <div class="row row-0">
                        <div class="col-sm-4">
