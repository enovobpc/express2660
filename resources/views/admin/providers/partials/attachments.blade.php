...
<div class="box no-border">
    <div class="box-body">
        <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable-attachments">
            <li>
                <a href="{{ route('admin.providers.attachments.create', $provider->id) }}" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-remote">
                    <i class="fas fa-plus"></i> @trans('Novo')
                </a>
            </li>
            <li>
                <a href="{{ route('admin.providers.attachments.sort', [$provider->id]) }}" class="btn btn-default btn-sm sort-attachments" data-toggle="modal" data-target="#modal-remote">
        ...
        <div class="selected-rows-action hide">
            {{ Form::open(['route' => ['admin.providers.attachments.selected.destroy', $provider->id]]) }}
